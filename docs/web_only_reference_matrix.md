...
| `src/ai_novelist/web/service.py` | retained Web workflows call this layer; outline helpers now live in `web/outline_service.py` | retain | continue P2 splitting for chapter helpers and orchestration boundaries |
